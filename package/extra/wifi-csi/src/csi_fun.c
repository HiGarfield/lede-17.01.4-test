...
void record_status(unsigned char* buf_addr, int cnt, csi_struct* csi_status) {
    if (is_big_endian()) {
        csi_status->tstamp =
                (((u_int64_t)buf_addr[0] << 56) & 0x00000000000000ffULL) |
                (((u_int64_t)buf_addr[1] << 48) & 0x000000000000ff00ULL) |
                (((u_int64_t)buf_addr[2] << 40) & 0x0000000000ff0000ULL) |
                (((u_int64_t)buf_addr[3] << 32) & 0x00000000ff000000ULL) |
                (((u_int64_t)buf_addr[4] << 24) & 0x000000ff00000000ULL) |
                (((u_int64_t)buf_addr[5] << 16) & 0x0000ff0000000000ULL) |
                (((u_int64_t)buf_addr[6] << 8) & 0x00ff000000000000ULL) |
                (((u_int64_t)buf_addr[7]) & 0xff00000000000000ULL);
        ...
        csi_status->tstamp =
                (((u_int64_t)buf_addr[7] << 56) & 0x00000000000000ffULL) |
                (((u_int64_t)buf_addr[6] << 48) & 0x000000000000ff00ULL) |
                (((u_int64_t)buf_addr[5] << 40) & 0x0000000000ff0000ULL) |
                (((u_int64_t)buf_addr[4] << 32) & 0x00000000ff000000ULL) |
                (((u_int64_t)buf_addr[3] << 24) & 0x000000ff00000000ULL) |
                (((u_int64_t)buf_addr[2] << 16) & 0x0000ff0000000000ULL) |
                (((u_int64_t)buf_addr[1] << 8) & 0x00ff000000000000ULL) |
                (((u_int64_t)buf_addr[0]) & 0xff00000000000000ULL);
